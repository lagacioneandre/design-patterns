...
exports.BasicPlayer = void 0;
var VideoPlayer_1 = require("./VideoPlayer");
var BasicPlayer = /** @class */ (function (_super) {
    __extends(BasicPlayer, _super);
    function BasicPlayer(videoDevice) {
        return _super.call(this, videoDevice) || this;
    }
    BasicPlayer.prototype.play = function (content) {
