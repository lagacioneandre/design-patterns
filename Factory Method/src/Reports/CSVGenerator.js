...
var CSVDocument_1 = require("./CSVDocument");
var DocumentGenerator_1 = require("./DocumentGenerator");
var CSVGenerator = /** @class */ (function (_super) {
    __extends(CSVGenerator, _super);
    function CSVGenerator() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CSVGenerator.prototype.createDocument = function () {
        return new CSVDocument_1.CSVDocument();
    };
    return CSVGenerator;
